...
# Color: Launcher 
gsettings set org.compiz.unityshell:/org/compiz/profiles/unity/plugins/unityshell/ background-color "${MOE_LAUNCHER_BG_COLOR}"
...
gsettings set org.compiz.unityshell:/org/compiz/profiles/unity/plugins/unityshell/ active-shadow-color "${MOE_ACTIVE_SHADOW_COLOR}"
gsettings set org.compiz.unityshell:/org/compiz/profiles/unity/plugins/unityshell/ inactive-shadow-radius 12
gsettings set org.compiz.unityshell:/org/compiz/profiles/unity/plugins/unityshell/ inactive-shadow-color "${MOE_INACTIVE_SHADOW_COLOR}" 
